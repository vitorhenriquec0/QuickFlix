    ...
    async ({ event, step }) => {
        ...
        await sendEmail({
            ...
            body: `<div style="font-family: Arial, sans-serif; line-height: 1.5;">
                        ...
                        <p>Your booking for <strong style="color: #F84565;">"${booking.show.movie.title}"</strong> has been successfully processed.</p>
                        <p>
                        ...
                        <p>Enjoy the showw!</p>
                        <p>Thanks for booking with us!<br/>- QuickFlix Team</p>
                    </div>`
        ...
        const results = await step.run('send-all-reminders', async () => {
            return await Promise.allSettled(
                reminderTasks.map(task => sendEmail({
                    ...
                    body: `<div style="font-family: Arial, sans-serify; padding: 20px;">
